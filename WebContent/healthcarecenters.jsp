...
<title>HealthCenters - NYC Travel Kit</title>
<meta property='og:site_name' content='NYC Travel Kit' />
<meta property='og:title' content='HealthCenters' />
...
<meta property='og:url' content='/healthcenters.jsp' />
...
<body class='  wsite-theme-light wsite-page-healthspots'>
<div id="wrapper">
...
<h2 class="wsite-content-title" style="text-align:left;">Search for Health Centers Ends Here...</h2>
...
<div class="paragraph" style="text-align:left;">
		<form id="tfnewsearch" method="post" action="/GetLatLong">
		        <input type="hidden" name="callingform" value="healthAccess">
...
<div class="wsite-map"><iframe allowtransparency="true" frameborder="0" scrolling="no" style="width: 100%; height: 500px; margin-top: 10px; margin-bottom: 10px;" src="/healthcarecentersMap.jsp"></iframe></div>
<% 
if(request.getSession().getAttribute("lat")!=null && request.getSession().getAttribute("lng")!=null){
	...
	<span class='imgPusher' style='float:left;height:0px'></span><span style='z-index:10;position:relative;float:left;max-width:50%;;clear:left;margin-top:0px;*margin-top:0px'><a><img src="/images/Woodhull.png" style="margin-top: 5px; margin-bottom: 10px; margin-left: 0px; margin-right: 10px; border-width:1px;padding:3px; height:125px; width:125px" alt="Picture" class="galleryImageBorder wsite-image" /></a><span style="display: block; font-size: 90%; margin-top: -10px; margin-bottom: 10px; text-align: center;" class="wsite-caption"></span></span>
	<div class="paragraph" style="text-align:left;display:block;">
	<ul>
	  <li>Health Center Name : <%=healthList.get(i).getHealth_name() %></li>
	  <li>Address : <%=healthList.get(i).getHealth_staddress() %></li>
	  <li>Borough : <%=healthList.get(i).getHealth_borough() %></li>
	  <li>Zip : <%=healthList.get(i).getHealth_zip() %></tli>
	  <li>Telephone : <%=healthList.get(i).getHealth_telephone() %></li>
	  </br>
	  </br>
	  </br>
	  </br>
