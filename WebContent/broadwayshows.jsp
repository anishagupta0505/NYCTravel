...
<html>
<head>
<%@page import="com.wse.NYCTravelKit.BroadwayShowDO"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.wse.NYCTravelKit.RDSManager"%>
<title>BroadwayShows - NYC Travel Kit</title>
<meta property='og:site_name' content='NYC Travel Kit' />
<meta property='og:title' content='BroadwayShows' />
...
<meta property='og:url' content='/broadwayshows.jsp' />
...
<body class='  wsite-theme-light wsite-page-broadwayshow'>
<div id="wrapper">
...
<h2 class="wsite-content-title" style="text-align:left;">Search for Broadway Shows Ends Here...</h2>
...
<div class="paragraph" style="text-align:left;">
		<form id="tfnewsearch" method="post" action="/GetLatLong">
		        <input type="hidden" name="callingform" value="broadwayAccess">
...
<div class="wsite-map"><iframe allowtransparency="true" frameborder="0" scrolling="no" style="width: 100%; height: 500px; margin-top: 10px; margin-bottom: 10px;" src="/broadwayshowsMap.jsp"></iframe></div>
<% 
if(request.getSession().getAttribute("lat")!=null && request.getSession().getAttribute("lng")!=null){
	...
	double lng = Double.parseDouble(request.getSession().getAttribute("lng").toString());
			   ...
			   ArrayList<BroadwayShowDO> showList = rdsM.getAllNearBroadwayLocations(lat,lng);
			   for(int i = 0 ; i < showList.size();i++){%> 
	<span class='imgPusher' style='float:left;height:0px'></span><span style='z-index:10;position:relative;float:left;max-width:50%;;clear:left;margin-top:0px;*margin-top:0px'><a><img src="/images/2408996.jpg" style="margin-top: 5px; margin-bottom: 10px; margin-left: 0px; margin-right: 10px; border-width:1px;padding:3px; height:125px; width:125px" alt="Picture" class="galleryImageBorder wsite-image" /></a><span style="display: block; font-size: 90%; margin-top: -10px; margin-bottom: 10px; text-align: center;" class="wsite-caption"></span></span>
	<div class="paragraph" style="text-align:left;display:block;">
	<ul>
	  <li>Brodaway Show : <%=showList.get(i).getShow_name() %></li>
	  <li>Theatre : <%=showList.get(i).getShow_theatre() %></li>
	  <li>Theatre Address : <%=showList.get(i).getShow_staddress() %></li>
	  <li>City : <%=showList.get(i).getShow_city() %></li>
	  <li>Theatre capacity : <%=showList.get(i).getShow_capacity() %></tli>
	  <li>Show opening : <%=showList.get(i).getShow_opening() %></li>
	  </br>
	  </br>
	  </br>
	  </br>
