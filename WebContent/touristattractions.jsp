...
<title>TouristSpots - NYC Travel Kit</title>
...
<h2 class="wsite-content-title" style="text-align:left;">Search for Tourist Spots Ends Here...</h2>
...
<div class="paragraph" style="text-align:left;">
		<form id="tfnewsearch" method="post" action="/GetLatLong">
		        <input type="hidden" name="callingform" value="touristAccess">
...
<div class="wsite-map"><iframe allowtransparency="true" frameborder="0" scrolling="no" style="width: 100%; height: 500px; margin-top: 10px; margin-bottom: 10px;" src="/touristattractionsMap.jsp"></iframe></div>
<% 
if(request.getSession().getAttribute("lat")!=null && request.getSession().getAttribute("lng")!=null){
	...
	<span class='imgPusher' style='float:left;height:0px'></span><span style='z-index:10;position:relative;float:left;max-width:50%;;clear:left;margin-top:0px;*margin-top:0px'><a><img src="/images/035.jpg" style="margin-top: 5px; margin-bottom: 10px; margin-left: 0px; margin-right: 10px; border-width:1px;padding:3px; height:125px; width:125px" alt="Picture" class="galleryImageBorder wsite-image" /></a><span style="display: block; font-size: 90%; margin-top: -10px; margin-bottom: 10px; text-align: center;" class="wsite-caption"></span></span>
	<div class="paragraph" style="text-align:left;display:block;">
	<ul>
	  <li>Tourist Name : <%=touristList.get(i).getTourist_name() %></li>
	  <li>Tourist Url : <%=touristList.get(i).getTourist_name() %></li>
	  <li>Tourist Address : <%=touristList.get(i).getTourist_staddress1() %> <%=touristList.get(i).getTourist_staddress2() %></li>
	  <li>Tourist City : <%=touristList.get(i).getTourist_locality() %></li>
	  <li>Tourist zip : <%=touristList.get(i).getTourist_zip() %></tli>
	  <li>Tourist Telephone : <%=touristList.get(i).getTourist_telephone() %></li>
	  </br>
	  </br>
	  </br>
	  </br>
